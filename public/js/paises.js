            ...
            $.each(iterador, function (i, abreviData) {
                for (i = 0; i < data.rows.length; i++) {
                    trHTML += '<tr class="odd gradeX">' +
                        ...
                        '<a href="/settings/countries/'+ data.rows[i][0].toString().toLowerCase() + '" class="btn btn-outline btn-circle btn-sm purple">' +
        ...
        .done(function (data) {
            ...
            if (typeof data.code !== 'undefined') {
                ...
                $.ajax({
                    ...
                    .done(function (data) {
                        swal({
                                ...
                                cancelButtonText: "Agregar otro pais",
                                closeOnConfirm: true
                            },
                            function (isConfirm) {
                                if (isConfirm) {
                                    ...
                                    window.location.href = "/settings/countries/new";
                                }
                            });
                    });
                return evitarSubmit;
                ...
                swal({
                    ...
                    $.ajax({
                        method: "PUT",
                        url: "/settings/countries/" + $idrol + "/ajax",
                        data: {
                            "value": $rol
                        }
                    })
...
function EliminarModal(id) {
    ...
    swal({
        title: "Se va eliminar el pais id: " + id,
        ...
        if (isConfirm) {
            $.ajax({
                method: "DELETE",
                url: "/settings/countries/" + id + "/ajax"
            })
                .done(function (data) {
                    setTimeout(function () {
                        swal({
